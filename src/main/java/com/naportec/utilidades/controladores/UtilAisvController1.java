 ...
 * @author Fernando
 */
public abstract class UtilAisvController1 implements Serializable {
    ...
    protected LazyDataModelAdvance<Precarga> listaExportacion;
    ...
    public void inicializar() {
        ...
        listaExportacion = new LazyDataModelAdvance<>(logTran);
...
//            listaExportacion.filtroEqualUnion("idLineaPrec.perfilamientoNavi", false);
     ...
     * @return
     */
    protected String validacionDatos() {
        //String mensajes = "";
    ...
    public void guardarAISV() throws Exception {
        try {
            ...
            Logger.getLogger(UtilAisvController1.class.getName()).log(Level.SEVERE, null, ex);
...
//    }
     ...
     */
    public LazyDataModelAdvance<Precarga> getListaExportacion() {
     ...
     */
    public void setListaExportacion(LazyDataModelAdvance<Precarga> listaExportacion) {
